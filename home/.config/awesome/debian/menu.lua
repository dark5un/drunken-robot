...
Debian_menu["Debian_Applications_Editors"] = {
	{"Emacs Snapshot (GTK)","/usr/bin/emacs-snapshot-gtk","/usr/share/emacs/24.3.50/etc/emacs.xpm"},
	{"Emacs Snapshot (text)", "x-terminal-emulator -e ".."/usr/bin/emacs-snapshot -nw","/usr/share/emacs/24.3.50/etc/emacs.xpm"},
